...
{
	class PaymentDateCell : DataGridViewTextBoxCell 
	{
		public PaymentDateCell()  : base(){
			Style.Format = "d";
		}
		public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle) {
			// Set the value of the editing control to the current cell value.
			base.InitializeEditingControl(rowIndex, initialFormattedValue, dataGridViewCellStyle);
			PaymentDateControl ctl = DataGridView.EditingControl as PaymentDateControl;
			ctl.Value = (DateTime)GetValue ( rowIndex );
		}

		public override Type EditType {
			get {
				return typeof(PaymentDateControl);
			}
		}
	...
	class PaymentDateControl : DateTimePicker, IDataGridViewEditingControl
	{
		private DataGridView dataGrid;
		private bool valueChanged = false;
		private int rowIndex;

		public PaymentDateControl() : base(){
